...
public enum Locales {
    ...
    HELP_SERVER_UUID_1("Help.Server.UUID.1", "Get the uuid of the given player."),
    ...
    HELP_PLAYER_MSG_1("Help.Player.Message.1", "Sends a private message to the last player who messaged you"),
    ...
    PLAYER_IP_OTHER("Player.Ip.Other", "%player%&7's ip address is %ip%"),
    ...
    SERVER_UUID("Server.UUID", "The UUID of player %player%&7 is: %uuid%"),
    ...
    TELEPORT_TPAHERE_SENT_TARGET("Teleport.tpa.sent.target.here", "%player%&7 wants to teleport you to his location. Type /tpahere yes to accept it!"),
