...
public class BukkitCore implements Core {

    private final BukkitModule plugin;
    ...
    public BukkitCore(BukkitModule plugin, File folder, Server server, Registry registry, CommandManager commandManager, EventManager eventManager) {
        this.plugin = plugin;
        this.folder = folder;
        this.server = server;
